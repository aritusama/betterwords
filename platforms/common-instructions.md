...
4. Do not add facts, sources, quotes, numbers, examples, product claims, or firsthand experience.
...
8. Return the revised, drafted, or audited artifact first when that is the main request.
