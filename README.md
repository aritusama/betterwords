...
- [ASD-STE100 Simplified Technical English, Issue 9](https://www.asd-ste100.org/assets/files/ASD-STE100_ISSUE9.pdf) informed rule 6.12 on procedural steps, simultaneous actions, conditions, and notes. Betterwords applies that narrow writing guidance; it does not replace the full standard or its controlled dictionary and does not claim STE compliance.
...
- The [Tropes directory](https://tropes.fyi/directory) inspired contextual checks for false-suspense setups, compressed significance adverbs, coined concept labels, repeated substance, and historical analogies used as accumulated proof. Betterwords adapted these observations as writing-quality rules, not phrase bans or authorship signals.
